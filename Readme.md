...
- 보스를 공격할 방법으로 매치3 퍼즐을 풀때마다 대응하는 캐릭터가 공격하는 방식

### 서브 컨세 3 : 성장

- 보다 보스를 쉽게 잡기 위한 방법으로 게임내 재화로 캐릭터의 공격력 등을 강화
...
- 무한정의 도전은 지루하게 만들기 때문에 도전할 기회를 제한 스테이지 도전시 고유재화 1개 소모 재충전에 5분 최대 10개 보유가능
