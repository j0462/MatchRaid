...
![image](https://user-images.githubusercontent.com/70842040/195475995-134db5dd-42d8-49c6-b212-58706877c778.png)

## c.행동

![image](https://user-images.githubusercontent.com/70842040/195475596-7a8eef5b-44f8-42cd-89c5-95986022283d.png)
...
### e-3) 기사-크리거(Keurigeo)
붉은 복장의 진중한 기사 느낌의 남성으로

한손장비인 레이피어를 주무기로 사용한다
...
9. 게임화면에서 퍼즐부분은 하단에 플레이어와 골렘은 상단에 위치한다.
10. 플레이어 캐릭터는 왼쪽, 골렘은 오른쪽에 위치한다.
11. 스테이지는 진행도에 따라 자물쇠표시를 이용하여 제한 표시를 한다.
12. 게임의 종료 조건은 골렘의 체력이 0이 되거나 타이머가 0이 될 경우다.
13. 타이머는 상단 중앙에 존재한다.
14. 게임화면에 실패든 클리어든 Ui가 중앙에 등장한다.
15. 클리어시 UI창에 클리어가 표시되고 다시하기, 다음스테이지, 나가기 3개의 버튼이 나온다.
16. 실패시 UI창에 실패가 표시되고 다시하기, 나가기 2개의 버튼이 나온다.
